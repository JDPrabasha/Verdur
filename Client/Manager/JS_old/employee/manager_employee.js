export default class Employee {
    ...
    addemployeenew(){
        ...
        // var employees = $("#employees");
        var employees =$("#results")
            var row_nomrmal = $(document.createElement('tr')).attr("id",`emp-${this.employeeid}`);
                var col_1 = $(document.createElement('td')).html(`<img class="emp-icon" src="${this.image}">`);
            ...
            var row_expand = $(document.createElement('tr')).attr("id",`emp-e-${this.employeeid}`).attr("class","hidden");
                ...
                var col_e_2 = $(document.createElement('td')).attr("style","width:1%;").html(`<div class="dropdown" id="hide-${parseInt(this.employeeid)}" style="padding:0;padding-right:4px;"><i class="material-icons" style="height:20px;width:20px">arrow_drop_up</i></div>`);
