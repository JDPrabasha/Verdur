            ...
            var singleRecord = $(document.createElement('div')).attr("class","flex-space-evenly").html(`
                            ...
                            <div style="flex-direction: column;">
                                ...
                                <div class="flex-space-evenly mt-3">
                                   <!-- <button id = "review-${this.dishID}" class= "btn-confirm  pl-12 ml-6" onclick="displaypop()">Review</button>-->
                                    <button id = "review-${this.dishID}" class= "btn-confirm  pl-12 ml-6">Review</button>
                                    <button id = "deny-${this.dishID}" class= "btn-reject pl-12 pt-7 pb-7 ml-6" style = "padding-left:10px;padding-right:10px;padding-top:5px;padding-bottom:5px;">Deny</button>
                                </div>
                                    <!-- <p>Rs.600</p> -->
